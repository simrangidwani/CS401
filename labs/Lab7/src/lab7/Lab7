	...
	public static void loadData(MovieDB movies) throws IOException
	{
		...
		Scanner S = new Scanner(new FileInputStream("movieFile.txt"));
                ...
                for (int i = 0; i < numItems; i++)
                {
                    ...
                    String aDirector = S.nextLine();
                    String aStudio = S.nextLine();
                    double gg = S.nextDouble();
                    
                    Movie m = new Movie(aTitle, aDirector, aStudio, gg);
	...
	public static void getCommands(MovieDB movies)
	{
		...
		while (true)
		{
			...
			else if (choice.equals("2"))
			{
                            ...
                            System.out.println("What is the Studio's name?: ");
                            studio = inScan.nextLine();
                            System.out.println("What is the gross?: ");
